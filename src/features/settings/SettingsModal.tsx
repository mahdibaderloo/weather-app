...
export default function SettingsModal() {
  ...
  return (
    <ul className="w-full lg:w-[60%] xl:w-1/3 flex-col mt-2 bg-linear-to-l from-violet-200 to-violet-900 dark:from-slate-950/95 dark:to-violet-950 rounded-3xl overflow-hidden absolute lg:right-[31%] top-34 lg:top-25.5 xl:top-31 xl:left-34 2xl:top-36 2xl:left-40">
      <li
        className={`text-violet-100 font-medium lg:text-sm cursor-pointer py-4 lg:py-2 2xl:py-3 px-6 hover:bg-violet-900 ${
          windUnit === "km/h"
