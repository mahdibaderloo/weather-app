...
export default function DailyForecast({ data }: DataProp) {
  return (
    <section className="lg:relative z-50 p-4 bg-linear-to-r from-violet-400/35 to-violet-800/60 dark:from-slate-950/50 dark:to-slate-950/95 rounded-4xl w-full lg:w-[49%] h-fit flex flex-col mt-3 lg:mt-0">
