...
export default function DailyItem({ data, day }: DailyProps) {
  ...
  return (
    <li className="flex items-center justify-between text-violet-100 lg:text-violet-300 dark:text-slate-400 lg:text-xl font-semibold py-4 lg:py-3 xl:py-3 2xl:py-4">
      ...
      <div className="flex items-center">
        <img
          src={icon}
          alt="icon"
          className="w-10 lg:w-7 xl:w-14 2xl:w-16 mr-2"
        />
