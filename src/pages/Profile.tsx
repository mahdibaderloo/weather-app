    ...
    <div className="lg:w-[86%] xl:w-[88%] h-full flex flex-col p-4 lg:p-0 lg:pr-6 lg:mr-4 lg:ml-30 lg:mt-30 xl:ml-32">
      ...
      <div className="w-full flex items-center mt-8 gap-4 lg:gap-8 p-4 lg:p-8 rounded-4xl bg-linear-to-l from-violet-200/75 to-violet-900/85 dark:from-slate-950/95 dark:to-violet-950/60 relative">
        <img
          src={profileIcon}
          alt="avatar"
          className="w-16 h-16 md:w-24 md:h-24 xl:w-30 xl:h-30 bg-linear-to-r from-violet-200/75 to-violet-700/65 dark:from-slate-950/95 dark:to-violet-700/30 rounded-3xl lg:rounded-4xl shadow p-2"
        />
