    ...
    <>
      <div className="flex justify-between items-center">
        <button
          ...
          className="bg-linear-to-r from-violet-900/90 to-violet-800/65 dark:from-violet-900/90 dark:to-slate-950/30 text-violet-100 text-lg font-medium w-fit px-8 py-3 rounded-4xl cursor-pointer shadow hover:bg-violet-950 transition-all"
        >
          Get My Location
        </button>
        <Link
