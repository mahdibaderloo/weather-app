...
export default function AirQualityIndex() {
  ...
  return (
    <div className="lg:w-[86%] xl:w-[92%] h-full flex flex-col lg:p-0 lg:pr-6 lg:mr-4 lg:ml-18 lg:mt-18 2xl:mt-0 2xl:w-full 2xl:ml-0">
      <h3 className="hidden font-bold xl:text-2xl xl:ml-8 text-violet-950 dark:text-violet-800 xl:block">
        Air Quality Index
      </h3>

      <div className="w-full flex lg:gap-4 mt-4 lg:mt-4 xl:mt-18 justify-center">
