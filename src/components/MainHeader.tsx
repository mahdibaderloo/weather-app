...
export default function MainHeader() {
  ...
  return (
    <header className="flex items-center justify-between w-full mt-8 lg:pr-8 lg:fixed lg:mx-22 lg:w-[90%] 2xl:static 2xl:w-full 2xl:mx-0">
      <form
        ...
        } flex items-center gap-2 w-full lg:w-[40%] 2xl:w-1/2 h-14 p-2 md:mx-8 2xl:mx-0 rounded-4xl shadow`}
      >
        <img
